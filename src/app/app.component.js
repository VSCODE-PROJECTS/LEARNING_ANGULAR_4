...
var PersonService = (function () {
    function PersonService(http) {
        this.http = http;
        this.personUrl = 'http://localhost:52173/fa-ir/Person/Create';
    }
    PersonService.prototype.createNewPerson = function (person) {
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.createPerson = function () {
        var _this = this;
        this.thePerson =
            new person_1.Person('Dariush Tasdighi', 10);
        this.personService.createNewPerson(this.thePerson)
            .subscribe(function (result) { return _this.thePerson = result; }, function (error) { return _this.errorMessage = error; });
    };
    return AppComponent;
}());
